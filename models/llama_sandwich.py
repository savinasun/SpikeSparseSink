...
class LlamaBlock(nn.Module):
    def __init__(self, hidden_size, num_heads, num_kv_heads, head_dim, intermediate_size, norm_eps):
        ...
        self.attn_post_norm = RMSNorm(hidden_size, eps=norm_eps)
        ...
        self.ffn_post_norm = RMSNorm(hidden_size, eps=norm_eps)
    ...
    def forward(self, x, position_embeddings, return_attention_map):
        ...
        h = x + self.attn_post_norm(attention_output)
        x = h + self.ffn_post_norm(self.ffn(self.ffn_norm(h)))
        return x, h, attention_map

    def reset_parameters(self):
        self.attn_norm.reset_parameters()
        self.attn.reset_parameters()
        self.attn_post_norm.reset_parameters()
        self.ffn_norm.reset_parameters()
        self.ffn.reset_parameters()
        self.ffn_post_norm.reset_parameters()
