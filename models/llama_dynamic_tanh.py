...
class DynamicTanh(nn.Module):
    def __init__(self, hidden_size, alpha_init_value):
        super().__init__()
        self.hidden_size = hidden_size
    ...
    def extra_repr(self):
        return f"alpha_init_value={self.alpha_init_value}"
...
class LlamaBlock(nn.Module):
    def __init__(self, hidden_size, num_heads, num_kv_heads, head_dim, intermediate_size, attn_alpha_init_value, ffn_alpha_init_value):
        super().__init__()
        self.attn_norm = DynamicTanh(hidden_size, alpha_init_value=attn_alpha_init_value)
        self.attn = Attention(
        ...
        self.ffn_norm = DynamicTanh(hidden_size, alpha_init_value=ffn_alpha_init_value)
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.layers = nn.ModuleList([
            LlamaBlock(
                ...
                attn_alpha_init_value=config.attn_alpha_init_value,
                ffn_alpha_init_value=config.ffn_alpha_init_value,
